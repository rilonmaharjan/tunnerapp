                ...
                builder: (context, state) {
                    return SingleChildScrollView(
                      ...
                      child: StickyHeader(
                        ...
                        content: state is HomeErrorState 
                          ? SizedBox(
                            height: 700,
                            child: Center(
                          ...
                          ? ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              if(state.songs[index].title.toLowerCase().contains(searchedSong.toLowerCase()) || state.songs[index].artist.toLowerCase().contains(searchedSong.toLowerCase())) {
                                return ListTile(
                                  ...
                                  subtitle: Text(
                                      state.songs[index].artist.toString(),
